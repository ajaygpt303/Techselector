      ...
      <Container>
        ...
        <Navbar.Collapse id="responsive-navbar-nav">
          <Nav className="mr-auto" activeKey={pathname}>
            ...
            >
              {[
                { label: 'V-High', filter: 'V-High' },
                { label: 'High', filter: 'High' },
                { label: 'Above-Average', filter: 'Above-Average' },
                { label: 'Average', filter: 'Average' },
                { label: 'Below-Average', filter: 'Below-Average' },
                { label: 'Low', filter: 'Low' },
                { label: 'V-Low', filter: 'V-Low' },
